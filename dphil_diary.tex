...
\begin{paper}[
	...
	\textbf{Notes:}
	\begin{itemize}
		\item PFNs: train transformers to approximate Bayesian posterior predictive distirbutions by sampling synthetic distirbutions, masking labels, and learning to predict them. At inference time, a single forward pass approximates Bayesian inference.
		\item PFNs \textit{approximate} these posteriors
		\item PFNs work for any prior distribution that can be sampled from
	\end{itemize}
\end{paper}
